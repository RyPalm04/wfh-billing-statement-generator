...
public class TabFiveFxmlController extends BaseController {
    ...
    private void initialize() {
        List<SpecialChargeLineItem> items = StatementContext.current().getSpecialCharges();
        int row = 0;
        List<CheckBox> checkBoxes = new ArrayList<>();
        for (SpecialChargeLineItem item : items) {
