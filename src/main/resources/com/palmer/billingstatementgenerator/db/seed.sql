INSERT INTO service_packages (sort_order, name, default_cost) VALUES
    (1, 'Traditional One',   0),
    (2, 'Traditional Two',   0),
    (3, 'Cremation One',     0),
    (4, 'Cremation Two',     0),
...
INSERT INTO services (sort_order, name, default_cost, included_in_package) VALUES
    (1,  'Basic Services of Funeral Director & Staff',     0, FALSE),
    (2,  'Embalming',                                       0, TRUE),
...
INSERT INTO merchandise (sort_order, name, default_cost, requires_description, sales_taxable, pricing_mode) VALUES
    (1,  'Casket or (alternative container)', NULL,  TRUE,  TRUE,  'flat'),
...
INSERT INTO special_charges (sort_order, name, default_cost, requires_description) VALUES
    (1, 'Grave Service Setup/Delivery',         NULL, TRUE),
...
INSERT INTO cash_advances (sort_order, name) VALUES
    (1,  'Grave Opening'),
